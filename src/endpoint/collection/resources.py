...
from .schemas import CollectionSchema, CollectionCreateSchema, CollectionUpdateSchema, ErrorSchema
...
class Collection(MethodView):
    ...
    @collection_bp.alt_response(404, ErrorSchema, description="Failed to delete the items")
