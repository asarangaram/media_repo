...
class Text2Time:
        ...
        if match:
            ...
            if groups[6]:
                if groups[6].strip() == "Z":
                    ...
                    timezone_value = timezone_sign * (
                        timezone_hours * 60 + timezone_minutes
                    )
            else:
                timezone_value = None
    ...
    @classmethod
    def create_custom_datetime(
        cls, year, month, day, hour, minute, second, timezone_value=None
    ):
        ...
        try:
            dt = datetime.datetime(
                year, month, day, hour, minute, second, tzinfo=tz_info
            )
